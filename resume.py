...
COMMON_SKILLS = [
    # Tech / programming
    "Python", "Java", "JavaScript", "SQL", "Git", "GitHub", "CI/CD",
    "Machine Learning", "Data Analysis", "AWS", "Azure", "Docker",
    # Healthcare / pharmacy
    "Patient Care", "HIPAA", "Pharmacy", "Medication", "Prescription",
    "Clinical", "Nursing", "CPR", "First Aid", "EMR",
    "Electronic Health Records",
    # Retail / sales
    "Customer Service", "Sales", "POS", "Point of Sale", "Merchandising",
    "Inventory Management", "Cash Handling", "Upselling", "Retail",
    # Food service / hospitality
    "Food Safety", "ServSafe", "Hospitality", "Catering", "Barista",
    # Office / admin / finance
    "Microsoft Office", "Excel", "Scheduling", "Data Entry",
    "Administrative", "Bookkeeping", "Accounting", "QuickBooks",
    # Education
    "Teaching", "Curriculum Development", "Tutoring",
    "Classroom Management",
    # Trades / manufacturing
    "Forklift", "Welding", "Quality Control", "Assembly",
    "Manufacturing", "OSHA", "Construction",
    # Soft skills / general
...
_STOPWORD_STARTS = {
    "The", "This", "That", "You", "We", "Our", "Your", "Job", "Apply",
    "About", "Please", "Note", "Job Description", "Requirements",
